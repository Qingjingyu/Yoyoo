...
const plans = [
    {
        id: "0",
        title: "checkout.form.monthly",
        value: 399,
    },
    {
        id: "1",
        title: "checkout.form.yearly",
        value: 349,
        save: 20,
    },
];
    ...
    return (
        <form action="" onSubmit={(event) => event.preventDefault()}>
            <div className="flex items-center mb-3 base2">
                <div className="mr-auto dark:text-n-4">{t("checkout.form.plan")}</div>
                <div className="mr-5 text-n-4">{t("checkout.form.changeCurrency")}</div>
            ...
            <div className="mb-3 border border-n-3 rounded-xl dark:border-n-5">
                <div className="p-5">
                    <div className="mb-3 base2 text-n-5">{t("checkout.form.billingEmail")}</div>
                    <div className="relative">
                        ...
                        <input
                            ...
                            type="email"
                            name="email"
                            placeholder={t("checkout.form.emailAddress")}
                            value={email}
                ...
                <div className="p-5 border-t border-n-3 dark:border-n-5">
                    <div className="mb-3 base2 text-n-5">{t("checkout.form.cardDetails")}</div>
                    <div className="flex md:flex-wrap">
                        ...
                        <div className="shrink-0 w-20 mx-8 md:ml-0 md:mr-auto">
                            <InputMask
                                ...
                                mask="99 / 99"
                                placeholder={t("checkout.form.mmYY")}
                                type="tel"
                                value={date}
                        ...
                        <div className="shrink-0 w-10">
                            <InputMask
                                ...
                                mask="999"
                                placeholder={t("checkout.form.cvc")}
                                type="tel"
                                value={code}
